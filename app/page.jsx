        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-4 xl:pb-24">
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <p className="max-w-[500px] mb-9 text-white/80">
              Frontend developer skilled in building responsive and
              user-friendly interfaces. Passionate about creating smooth,
              visually appealing user experiences. Always eager to learn,
              improve, and collaborate effectively.
            </p>
